...
window.BOARD_DATA = (() => {
  ...
  return {
    version:'R1', canvas:'9:16', kind:'SCHEMATIC_TIMED_BOARDS_NOT_GENERATED_FOOTAGE',
    routes:[
      {id:'A',title:'She Moved First',mechanism:'Imitation becomes initiative',question:'Who is setting the rhythm?',risk:'The leadership reversal must read as a decision, not a repeating pose loop.',shots:[
        ...
        shot(3,'Skyy is revealed','The frame widens: Skyy shares the red model’s stance.','Reveal the recurring character clearly.',cast(person('red',170),person('skyy',355)),{fronts:['kids-001'],cut:true}),
        shot(3,'The test','Red deliberately places a hand on the hip. Skyy waits one beat.','Make imitation a visible question.',cast(person('red',170,'leftHip'),person('skyy',355)),{fronts:['kids-001']}),
        shot(3,'The answer','Skyy repeats the hand-on-hip stance; red watches.','Confirm the rule before reversing it.',cast(person('red',170,'leftHip'),person('skyy',355,'leftHip')),{fronts:['kids-001']}),
        shot(3,'Her own move','Red holds. Skyy lowers that hand, shifts to the other hip and steps sideways.','Skyy initiates rather than copies.',cast(person('red',170,'leftHip'),person('skyy',330,'rightHip')),{fronts:['kids-001']}),
        shot(3,'The lead changes','Red lowers the original hand and mirrors Skyy’s new stance. Skyy holds.','The child now responds to Skyy.',cast(person('red',195,'rightHip'),person('skyy',330,'rightHip')),{fronts:['kids-001']}),
        shot(3,'Make it three','The planted purple model steps forward. Both turn their attention and make room.','Expand from a pair to the capsule ensemble.',cast(person('red',120),person('skyy',265),person('purple',410)),{fronts:['kids-001','kids-002'],cut:true}),
        shot(3,'A shared frame','Hold all three frontally within the observation-car architecture.','Let character recognition and both products register.',cast(person('red',120),person('skyy',265),person('purple',410)),{fronts:['kids-001','kids-002']})
      ]},
