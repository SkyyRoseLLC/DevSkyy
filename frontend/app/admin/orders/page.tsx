...
export default async function OrdersPage() {
  // The session is request-bound; opt this page out of static prerendering
  // before deciding whether WooCommerce data may be fetched.
  await connection();
            ...
            <ConsoleCard key={label} className='p-5'>
              ...
              <div
                ...
                style={{
                  ...
                  color: label === 'Fulfilled' ? '#5FBF7F' : label === 'Processing' ? '#E5A85C' : 'var(--acc)',
                }}
              >
                {formatCount(value)}
              </div>
