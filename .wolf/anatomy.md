...
- `tasks/v2-launch-ad-campaigns.html` — V2 (House of Roses) launch ad-campaign spec of record: 6 gpt_image_2 sheets (prompts, Element refs, verified credits), 3 motion clips, channel plan, QC gate, STOP-AND-SHOW protocol + job registry. ~11k tokens. Created 2026-09-11.
