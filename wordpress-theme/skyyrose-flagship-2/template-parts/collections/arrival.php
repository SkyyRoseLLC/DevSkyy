...
<header data-recovery-hero class="sr2-world-arrival sr2-world-arrival--cinematic">
	...
	<figure class="sr2-world-arrival__monument"><div class="sr2-recovery-hero-media">
		...
		<?php if ( $arrival_motion ) : ?><video data-recovery-hero-video muted loop playsinline preload="none" aria-hidden="true"><source data-src="<?php echo esc_url( $arrival_motion['webm'] ); ?>" type="video/webm"><source data-src="<?php echo esc_url( $arrival_motion['mp4'] ); ?>" type="video/mp4"></video><?php endif; ?>
