	...
	<section class="sr2-jersey-reveal" aria-labelledby="sr2-jersey-series-title" data-presentation="jersey-series">
		...
		<div class="sr2-house-film" data-house-film data-house-film-autoplay="once" data-media-status="founder-review-candidate">
			<div class="sr2-house-film__media">
				<video width="1920" height="1080" muted playsinline preload="none" poster="<?php echo esc_url( SKYYROSE2_URI . '/assets/video/skyyrose-tour-around-the-bay-poster.webp?ver=' . skyyrose2_asset_version( '/assets/video/skyyrose-tour-around-the-bay-poster.webp' ) ); ?>" data-house-film-video aria-label="<?php esc_attr_e( 'The Town Line Jersey Series previsualization', 'skyyrose-flagship-2' ); ?>">
					<source data-src="<?php echo esc_url( SKYYROSE2_URI . '/assets/video/skyyrose-tour-around-the-bay.webm?ver=' . skyyrose2_asset_version( '/assets/video/skyyrose-tour-around-the-bay.webm' ) ); ?>" type="video/webm">
					<source data-src="<?php echo esc_url( SKYYROSE2_URI . '/assets/video/skyyrose-tour-around-the-bay.mp4?ver=' . skyyrose2_asset_version( '/assets/video/skyyrose-tour-around-the-bay.mp4' ) ); ?>" type="video/mp4">
				</video>
			...
			<p class="sr2-house-film__transcript"><?php esc_html_e( 'Visual transcript: eight Jersey Series fronts appear in order: black baseball, red football, white football, white basketball, black and teal hockey, green baseball, black and orange baseball, and white baseball. The Town Line connects the collection through Oakland, San Francisco, The Bay, and San Jose.', 'skyyrose-flagship-2' ); ?></p>
		</div>
		<?php if ( $show_product_grid ) : ?>
		<div class="sr2-jersey-reveal__grid sr2-products">
