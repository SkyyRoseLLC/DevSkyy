	...
	<main id="primary" class="sr2-page sr2-page--<?php echo esc_attr( $slug ); ?>">
		...
		<?php elseif ( 'pre-order' === $slug || 'preorder' === $slug ) : ?>
			...
			<section class="sr2-preorder-hero" aria-labelledby="sr2-page-title">
				...
				<div class="sr2-preorder-hero__copy"><p class="sr2-eyebrow"><?php esc_html_e( 'Pre-Order Collection', 'skyyrose-flagship-2' ); ?></p><h1 id="sr2-page-title"><?php esc_html_e( 'Choose the piece that speaks to you.', 'skyyrose-flagship-2' ); ?></h1><p><?php esc_html_e( 'Orders use standard checkout. The pre-order label does not reserve stock or defer payment.', 'skyyrose-flagship-2' ); ?></p><a class="sr2-button sr2-button--fill" href="#reserve"><?php esc_html_e( 'View pieces', 'skyyrose-flagship-2' ); ?></a></div>
			</section>
			<?php
			...
			<section class="sr2-preorder-steps" aria-labelledby="sr2-preorder-steps-title">
				...
				<div><article><span>01</span><h3><?php esc_html_e( 'Choose your world', 'skyyrose-flagship-2' ); ?></h3><p><?php esc_html_e( 'Enter collection story and find piece carrying your code.', 'skyyrose-flagship-2' ); ?></p></article><article><span>02</span><h3><?php esc_html_e( 'Select your piece', 'skyyrose-flagship-2' ); ?></h3><p><?php esc_html_e( 'Confirm size, price, and availability. Contact Client Services for shipping estimates.', 'skyyrose-flagship-2' ); ?></p></article><article><span>03</span><h3><?php esc_html_e( 'Review your order', 'skyyrose-flagship-2' ); ?></h3><p><?php esc_html_e( 'Review your order at checkout and follow its status in your account.', 'skyyrose-flagship-2' ); ?></p></article></div>
			</section>
			<?php skyyrose2_render_collection_rail(); ?>
			<section id="reserve" class="sr2-section sr2-section--products"><header class="sr2-section-head"><p><?php esc_html_e( 'Browse the collection', 'skyyrose-flagship-2' ); ?></p><h2><?php esc_html_e( 'Future pieces. Present choice.', 'skyyrose-flagship-2' ); ?></h2><p class="sr2-section-head__note"><?php esc_html_e( 'Review each product before ordering. Contact Client Services if you need a shipping estimate.', 'skyyrose-flagship-2' ); ?></p></header><?php skyyrose2_product_cards( 12, 'pre-order' ); ?></section>
