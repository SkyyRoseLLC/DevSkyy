...
- **Pose:** Front view straight-on (laid flat or on a model) showing the white body + the vertical black contrast side-panel + the small Red Roses Cloud Cluster on the left thigh + the black drawstring. For the back: clean back panel showing the contrast side-panel continuing.
