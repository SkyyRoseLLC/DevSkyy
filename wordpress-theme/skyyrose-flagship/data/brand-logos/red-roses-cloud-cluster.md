...
A vertical cluster of three illustrated **RED roses** on a cloud, with thorny
green vines wrapping around the stems:

- **Three roses, vertically stacked, comic-book illustrated style** with hard
  ink edges and tonal red shading.
...
- **Bright red** (rose petals): `~#D52327` to `~#E63B3B`.
- **Dark red** (rose shading): `~#8A1A1F`.
- **Black** (ink outlines on petals): pure black.
- **Kelly green** (stems, vines): `~#1F8B3D`.
- **Dark green** (vine shading): `~#0E5524`.
- **White** (cloud body): pure white.
- **Pale blue** (cloud underside shading): `~#B8D8E8`.
...
- **Silicone appliqué**: Raised silicone with the multi-color art preserved.
- **Printed**: Flat-ink full-color version.
