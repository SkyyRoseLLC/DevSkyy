...
_CANONICAL_SELECTIONS: dict[tuple[str, str], str] = {
    ...
    ("lh-003", "front"): ("assets/products/source-photos/love-hurts/lh-003-shorts-front.jpeg"),
    ("lh-003", "back"): ("assets/products/source-photos/love-hurts/lh-003-shorts-back.jpeg"),
}
