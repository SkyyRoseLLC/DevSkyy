...
**Version**: 3.2.0 **Last Updated**: 2026-02-22

Complete reference for all Python and JavaScript/TypeScript dependencies used in
the DevSkyy platform.

---

## Python Dependencies

**Source**: `pyproject.toml` **Total**: 46 core dependencies + optional
dependency groups
...
Includes: torch, torchvision, torchaudio, huggingface-hub, pandas, scikit-learn,
accelerate, datasets, nltk, spacy, mlflow, bentoml, wandb, tensorboard,
matplotlib, seaborn, plotly, librosa, statsmodels, prophet, gymnasium,
stable-baselines3, shap, lime, polars, pyarrow, hydra-core, llama-index
...
**Source**: `package.json` **Total**: 90 dependencies + 20 devDependencies
...
**Document Owner**: DevSkyy Platform Team **Next Review**: When dependencies are
updated
