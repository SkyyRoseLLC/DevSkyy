...
def require_permissions(required_permissions: List[str]):
    ...
    def permission_checker(current_user: Auth0User = Depends(
            get_current_user)) -> Auth0User:
...
def create_devskyy_jwt_token(
        user_data: Dict[str, Any], expires_delta: Optional[timedelta] = None) -> str:
