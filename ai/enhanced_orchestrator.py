...
class EnhancedAIOrchestrator:
    ...
    async def initialize(
        ...
        try:
            ...
            logger.info(
                f"🚀 Enhanced AI Orchestrator initialized with {len(self.models)} models")
    ...
    def _balanced_model_selection(self, available_models: List) -> str:
        ...
        for model_name, config in available_models:
            ...
            cost_score = 1 / (config.cost_per_token + 0.000001)
            health_score = self.health_status.get(
                model_name, {}).get(
                "score", 0.5) * 100
    ...
    def _update_metrics(self, response: AIResponse):
        ...
        self.metrics["cache_hit_rate"] = cached_requests / \
        ...
        for model_name, config in self.models.items():
            ...
            try:
                ...
                self.health_status[model_name] = {
                    ...
                    "score": min(1.0, 2.0 / (response_time + 1.0))
                }
