...
class OrchestrationSystemTest:
    ...
    async def test_central_command_init(self) -> bool:
        ...
        try:
            ...
            if len(central.partnerships) != 4:
                logger.error(
                    f"Expected 4 partnerships, got {len(central.partnerships)}")
                return False
            ...
            if expected_types != actual_types:
                logger.error(
                    f"Partnership types mismatch: {expected_types} vs {actual_types}")
                return False
    ...
    async def test_error_handling(self) -> bool:
        ...
        try:
            ...
            try:
                progress = await central._check_deliverable_progress(
