...
# Generate a community welcome post in Corey's voice for #welcome
...
# Generate a Monday Concrete discussion prompt for the week of a Black Rose drop
...
```bash
# Smoke-test the social venture with the community-launch content type
...
```json
// Weekly engagement automation config (n8n or equivalent scheduler)
{
  "schedule": "weekly",
  "tasks": [
    {
